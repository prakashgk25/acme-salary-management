...
public class Employee {
    ...
    @Column(nullable=false, unique=true, length=30) private String employeeNumber;
    ...
    @Column(nullable=false, precision=19, scale=2) private BigDecimal annualSalary;
    @Column(nullable=false) private LocalDate effectiveDate;

    public Long getId(){return id;} public Long getVersion(){return version;}
    ...
    public BigDecimal getAnnualSalary(){return annualSalary;} public void setAnnualSalary(BigDecimal v){annualSalary=v;}
